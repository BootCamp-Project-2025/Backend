...
export default class StudentTrackProgressController
  implements IStudentTrackProgressController
{
  constructor(
    @inject("IStudentTrackProgressService")
    private readonly studentTrackService: IStudentTrackProgressService
  ) {}

  create = async (req: Request, res: Response): Promise<void> => {
    try {
      const dto: StudentTrackProgressDto = req.body as StudentTrackProgressDto;
      const domain: StudentTrackProgress =
        StudentTrackProgressMapper.DtoToDomain(dto);
